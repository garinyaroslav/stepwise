...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT u FROM User u JOIN u.groups g WHERE g.id = :groupId AND u.tempPassword IS NOT NULL")
    List<User> findAllByGroupIdAndTempPasswordIsNotNull(@Param("groupId") Long groupId);
